...
6. Go to `localhost:5005` with your favorite browser.
...
- Home page: [GET localhost:5005/](localhost:5005/)
- Item browse: [GET localhost:5005/items](localhost:5005/items)
- Item read: [GET localhost:5005/items/:id](localhost:5005/items/2)
- Item edit: PUT localhost:5005/items/:id
- Item add: POST localhost:5005/items
- Item deletion: DELETE localhost:5005/items/:id
